...
function Footer() {
  return (
    ...
    <footer className="pt-12 pb-5 bg-dark">
      <div className="flex flex-wrap md:mx-auto">
        <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3 ">
          <h2 className='font-bold text-white text-4xl mb-5'>Rivensin</h2>
      ...
      <div className="w-full pt-10 border-t border-slate-700">
        ...
        <div className='font-medium text-xs text-slate-500 text-center max-w-sm mx-auto'>
