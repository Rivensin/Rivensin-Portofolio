    ...
    <section id='clients' className="pt-36 pb-32 bg-slate-800">
      <div className="container">
        ...
        <div className="mx-auto text-center mb-16">
            ...
            <p className='font-medium text-md text-slate-300 md:text-lg md:text-lg'>
        ...
        <div className='w-full px-4'>
          <div className="flex flex-wrap justify-center items-center">
            <a href="" className='max-w-[125px] mx-4 my-4 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-500 lg:mx-6 xl:mx-8 scale-[.70]'>
              <img src="img/clients/xiaomi.svg" alt="xiaomi" />
            </a>
            <a href="" className='max-w-[125px] mx-4 my-4 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-500 lg:mx-6 xl:mx-8'>
              <img src="img/clients/bumn.svg" alt="bumn" />
            </a>
            <a href="" className='max-w-[125px] mx-4 my-4 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-500 lg:mx-6 xl:mx-8'>
              <img src="img/clients/gojek.svg" alt="gojek" />
            </a>
            <a href="" className='max-w-[125px] mx-4 my-4 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition duration-500 lg:mx-6 xl:mx-8'>
              <img src="img/clients/telkom.svg" alt="telkom" />
            </a>
          </div>
